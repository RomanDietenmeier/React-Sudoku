    ...
    s(e, [
        ...
        value: function t() {
          ...
          (t
            ...
            this.notificationsGap &&
              this.container.style.setProperty(
                "--sn-notifications-gap",
                "".concat(this.notificationsGap, "px"),
              ));
        },
      },
      {
        ...
        value: function t() {
          (this.container.classList[
            this.position === "center" ? "add" : "remove"
          ](d.IS_CENTER),
            this.container.classList[
              this.position.includes("left") ? "add" : "remove"
            ](d.IS_LEFT),
            this.container.classList[
              this.position.includes("right") ? "add" : "remove"
            ](d.IS_RIGHT),
            this.container.classList[
              this.position.includes("top") ? "add" : "remove"
            ](d.IS_TOP),
            this.container.classList[
              this.position.includes("bottom") ? "add" : "remove"
            ](d.IS_BOTTOM),
            this.container.classList[
              this.position.includes("x-center") ? "add" : "remove"
            ](d.IS_X_CENTER),
            this.container.classList[
              this.position.includes("y-center") ? "add" : "remove"
            ](d.IS_Y_CENTER));
        },
      },
      {
        ...
        value: function t() {
          ...
          switch (
            ...
            this.wrapper.style.setProperty(
              "--sn-notify-transition-duration",
              "".concat(this.speed, "ms"),
            ),
      ...
      },
      {
        ...
        value: function t() {
          switch (this.effect) {
            case p.FADE:
              ((this.selectedNotifyInEffect = v),
                (this.selectedNotifyOutEffect = N));
              break;
            case p.SLIDE:
              ((this.selectedNotifyInEffect = O),
                (this.selectedNotifyOutEffect = T));
              break;
            default:
              ((this.selectedNotifyInEffect = v),
                (this.selectedNotifyOutEffect = N));
